...
<div class="mx-auto w-auto text-center text-gray-400 underline">
  <a href={"/placards/" + data.params.translation + "/" + data.params.book + ".pdf"} target="blank">One verse per page (PDF)</a>
</div>
{/if}
